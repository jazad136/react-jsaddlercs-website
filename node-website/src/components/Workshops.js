...
const Workshops = () => {
  return (
    <dl class="workshops">
      ...
      <dd><ol>
      <li>
        Peterson, C. S., <span class="me">Saddler, J.</span>, Blascheck, T., and Sharif, B. 
        &quot;Visually Analyzing Students' Gaze on C++ Code Snippets,&quot; in 
        <span class="paper">Proceedings of the 6th International Workshop on 
      ...
      <li>
        Peterson, C. S., Halavick, N. M., <span class="me">Saddler, J. A.</span>, and Sharif, B. 
        &quot;A Gaze-Based Exploratory Study on the Information Seeking Behavior of Developers on Stack Overflow&quot;, in 
        <span class="paper">CHI '19, Extended Abstracts of the SIGCHI Conference on Human Factors in Computing Systems.</span>&nbsp; 
        Glasgow, Scotland, May 2019. [Online]<br/>
        Available: https://doi.org/10.1145/3290607.3312801<br/>
        <span class="website"><a href="https://dl.acm.org/citation.cfm?id=3312801">Website available at: ACM DL</a></span></li>
       <li>
         <span class="me">Saddler, J. A.</span>, and Cohen, M.  B. 
         &quot;EventFlowSlicer: Goal Based Test Case	 Generation for Graphical User Interfaces,&quot; in
         <span class="paper">Proceedings of the 7th
         ...
         <span class="website"><a href="https://cse.unl.edu/~myra/artifacts/EventFlowSlicer/">Website Available</a></span></li>
      </ol></dd>
    </dl>
  );
};
