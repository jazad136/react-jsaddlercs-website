    ...
    <dl className="conference">
        ...
        <ol>
            ...
            <li>
                ...
                in 
                <span className="paper">Proceedings of the 21st International Conference on Human Computer Interaction (HCII 2019).</span>&nbsp;
            ...
            <li>
                ...
                Bagheri, H., Cohen, M. B., and Farritor, S. &quot;Modeling and Testing a Family of Surgical Robots: An Experience Report&quot;,  in <span className="paper">The 26th ACM Joint European  Software Engineering Conference and Symposium on the Foundations of Software Engineering (ESEC/FSE)</span>&nbsp;
                , Nov. 2018. [Online]<br/>
            ...
            <li>
                ...
                <span className="preprint"><a href={efstool_pdf}>Preprint Available</a></span></li>
